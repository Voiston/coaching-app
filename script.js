...
function suiviProgressState(pct) {
    ...
    if (n >= 50) return { class: 'suivi-header-item--mid', message: n === 50 ? '50% — à mi-chemin !' : n + '% — plus que la moitié !' };
    if (n > 0) return { class: 'suivi-header-item--start', message: n + '% — chaque pas compte.' };
